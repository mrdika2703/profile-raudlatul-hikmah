...
import type { NewsFormData } from "./Index";
...
export default function ModalCrud({
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      payload.append("tanggal_kegiatan", formData.tanggal_kegiatan);
      ...
      if (modalMode === "create") {
        ...
        await api.post(`/news/${selectedId}`, payload, {
          headers: { "Content-Type": "multipart/form-data" },
        });
    ...
    <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl border border-pink-100 relative my-8 animate-scale-up">
        ...
        <p className="text-xs text-slate-500 mb-6">
          Isi detail informasi kegiatan atau berita yang ingin dipublikasikan.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              type="text"
              required
              placeholder="Contoh: Pentas Seni dan Perpisahan Tahun 2026"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, tanggal_kegiatan: e.target.value })
                }
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-pink-500 font-medium"
              />
            </div>
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 uppercase mb-1">
              Keterangan / Deskripsi Berita
            </label>
            <textarea
              rows={4}
              placeholder="Tuliskan rinci berita atau informasi kegiatan di sini..."
          ...
          <div className="space-y-3 pt-2">
            <label className="block text-xs font-bold text-slate-700 uppercase">
              Upload Foto Kegiatan (Opsional, Maks 3 Foto)
            </label>
          ...
          <div className="pt-4 flex items-center justify-end gap-3 border-t border-slate-100 mt-6">
            ...
            >
              ...
              <span>
                {modalMode === "create" ? "Simpan Berita" : "Update Berita"}
              </span>
            </button>
          </div>
        </form>
